...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(AddopMul AddopMul) { visit(); }
    ...
    public void visit(RelopTypeComparaison RelopTypeComparaison) { visit(); }
    public void visit(RelopTypeEquality RelopTypeEquality) { visit(); }
    ...
    public void visit(FactorDesignatorMethodCall FactorDesignatorMethodCall) { visit(); }
    ...
    public void visit(CondFactMultipleComparaison CondFactMultipleComparaison) { visit(); }
    public void visit(CondFactMultipleEquality CondFactMultipleEquality) { visit(); }
    public void visit(CondFactSingle CondFactSingle) { visit(); }
    public void visit(PlaceAfterFirstConditionInAnd PlaceAfterFirstConditionInAnd) { visit(); }
    public void visit(CondTermSingle CondTermSingle) { visit(); }
    public void visit(CondTermMultiple CondTermMultiple) { visit(); }
    public void visit(PlaceAfterFirstConditionInOr PlaceAfterFirstConditionInOr) { visit(); }
    public void visit(ConditionSingle ConditionSingle) { visit(); }
    public void visit(ConditionMultiple ConditionMultiple) { visit(); }
    public void visit(ConditionInIfError ConditionInIfError) { visit(); }
    public void visit(ConditionInIfExists ConditionInIfExists) { visit(); }
    public void visit(ActParsOptionalEmpty ActParsOptionalEmpty) { visit(); }
    ...
    public void visit(DesignatorStatementAssignArrayStart DesignatorStatementAssignArrayStart) { visit(); }
    ...
    public void visit(PlaceAfterIfBlock PlaceAfterIfBlock) { visit(); }
    public void visit(PlaceAfterIfCondition PlaceAfterIfCondition) { visit(); }
    ...
    public void visit(FormParsOptionalEmpty FormParsOptionalEmpty) { visit(); }
    ...
    public void visit(VarDeclGlobalExists VarDeclGlobalExists) { visit(); }
    ...
    public void visit(ConstDeclInnerListElement ConstDeclInnerListElement) { visit(); }
    public void visit(ConstDeclInnerListMultiple ConstDeclInnerListMultiple) { visit(); }
    public void visit(ConstDeclInnerListSingle ConstDeclInnerListSingle) { visit(); }
    public void visit(ConstDecl ConstDecl) { visit(); }
    public void visit(ProgramDeclListEEmpty ProgramDeclListEEmpty) { visit(); }
